    ...
    public function index() {
        ...
        foreach ($order_list as $order_id => $order) {
            ...
            if ($order['order_state'] == ORDER_STATE_NEW || $order['order_state'] == ORDER_STATE_DEPOSIT || $order['order_state'] == ORDER_STATE_REST) {
                ...
                $order_group_list[$order['pay_sn']]['pay_amount'] += ($order['order_state'] == ORDER_STATE_DEPOSIT?$order['presell_deposit_amount']:$order['order_amount']) - $order['pd_amount'] - $order['rcb_amount'];
            }
